...
from ..model.network import uestc_stgcn
...
class UESTCMetrics(Metric):
    ...
    def __init__(self,
        ...
        datapath = os.path.join(cfg.data.smpl_path, "kintree_table.pkl")
        # init classifier module
        self.stgcn_classifier = uestc_stgcn.STGCN(
            in_channels=6,
            kintree_path=datapath,
            num_class=cfg.data.categorization_num,
            graph_args={
                "layout": "smpl",
                "strategy": "spatial"
            },
        ...
        # load pretrianed
        model_path = os.path.join(cfg.test.uestc_rec_path,  "uestc_rot6d_stgcn.tar")
